...
const buttonUrl = `https://www.mfind.pl/ubezpieczenie-oc-ac/kalkulator-oc-ac?make_name=${brandSelect}&model_name=${modelSelect}&fuel_name=${fuelSelect}`
...
return (<>
    ...
    <FormButton disabled={typeof(brandSelect,modelSelect,fuelSelect) === 'string'? false:true}  url={buttonUrl} name={'oblicz składkę'}></FormButton>
    </>);
}
